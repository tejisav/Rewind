angular.module('rewind.services').factory("imageService", function($q,rewindConfig) {
    ...
    var imageService={
        ...
        makeMiniature : function(fileName){
            ...
            var self=this;
            var defered=$q.defer();
            var imageUrl = rewindConfig.appRootStorage + 'artworks/' + fileName;
        ...
        storeBase64Image : function(base64Image, folder,imageFileName){
            ...
            var path=rewindConfig.appRootStorage + folder;
            // Get the directory
