...
angular.module('rewind.services').factory("onlineArtwork", function($q,rewindConfig, $http, $cordovaFileTransfer) {
            ...
            $http.get(url,{timeout : 30000}).success(function(data){
                ...
                if (data.results.length > 0){
                    ...
                    if (artistName !== title.artist){
                        ...
                        var p1 = $cordovaFileTransfer.download(url600,rewindConfig.appRootStorage + 'artworks/'+imageFileName,options,trustHosts);
                        var p2 = $cordovaFileTransfer.download(url300,rewindConfig.appRootStorage + 'miniatures/'+imageFileName,options,trustHosts);
