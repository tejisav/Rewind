...
angular.module('rewind.controllers').controller('ManageDirectoriesCtrl', function ($scope, deviceFS, $cordovaToast, $ionicLoading, $ionicModal, $timeout, fileFactory, $localstorage, $ionicListDelegate) {
